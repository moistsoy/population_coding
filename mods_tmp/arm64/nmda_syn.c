...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDAsyn /Users/ryu/Documents/Project/Population Coding/codes/mods/nmda_syn.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
   s = 1.0 / ( 1.0 + exp ( - 0.062 * _lv ) * ( 1.0 / 3.57 ) ) ;
    return 0; }
...
{  double* _p; Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 ...
 _tsav = t; {
    ...
    double __state = A;
    double __primary = (A + factor) - __state;
 ...
 A = A + factor ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    /* discon state adjustment for cnexp case (rate uses no local variable) */
    double __state = B;
    double __primary = (B + factor) - __state;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/ryu/Documents/Project/Population Coding/codes/mods/nmda_syn.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
